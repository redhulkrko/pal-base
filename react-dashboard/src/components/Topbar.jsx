              ...
              <div className="dropdown-menu dropdown-menu-end dropdown-list animated--grow-in">
                ...
                <a className="dropdown-item d-flex align-items-center" href="#">
                  <div className="me-3 dropdown-list-image">
                    <img className="rounded-circle" src="/assets/img/avatars/avatar4.jpeg" alt="Emily Fowler" />
                ...
                <a className="dropdown-item d-flex align-items-center" href="#">
                  <div className="me-3 dropdown-list-image">
                    <img className="rounded-circle" src="/assets/img/avatars/avatar2.jpeg" alt="Jae Chun" />
                ...
                <a className="dropdown-item d-flex align-items-center" href="#">
                  <div className="me-3 dropdown-list-image">
                    <img className="rounded-circle" src="/assets/img/avatars/avatar3.jpeg" alt="Morgan Alvarez" />
                ...
                <a className="dropdown-item d-flex align-items-center" href="#">
                  <div className="me-3 dropdown-list-image">
                    <img className="rounded-circle" src="/assets/img/avatars/avatar5.jpeg" alt="Chicken the Dog" />
                    <div className="bg-success status-indicator"></div>
                  </div>
                  <div className="fw-bold">
                    <div className="text-truncate">
